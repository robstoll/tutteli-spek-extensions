...
[![Build Status Travis](https://travis-ci.org/robstoll/tutteli-spek-extensions.svg?tag=v0.7.0)](https://travis-ci.org/robstoll/tutteli-spek-extensions/branches)
...
dependencies {
    testImplementation 'ch.tutteli.spek:tutteli-spek-extensions:0.7.0'
}
```
